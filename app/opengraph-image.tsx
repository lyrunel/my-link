...
async function getFontData(): Promise<ArrayBuffer | null> {
  ...
  try {
    ...
    if (buffer && buffer.byteLength > 0) {
      ...
      console.log(
        "[OG Debug Static] Font downloaded successfully from primary CDN. Size:",
        buffer.byteLength
      )
      return cachedFontData
    }
    ...
    console.warn(
      "[OG Debug Static] Primary CDN failed, trying backup CDN...",
      err
    )
    try {
      ...
      if (buffer && buffer.byteLength > 0) {
        cachedFontData = buffer
        console.log(
          "[OG Debug Static] Font downloaded successfully from backup CDN. Size:",
          buffer.byteLength
        )
        return cachedFontData
      }
      ...
      console.error(
        "[OG Debug Static] All font fetch attempts failed!",
        backupErr
      )
